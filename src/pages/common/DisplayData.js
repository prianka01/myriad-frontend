...
import { deleteData, updateData } from "/Users/hp/Desktop/github/myriad/frontend/src/api";
          ...
          : data.map((dat) => (
            <div id="card" class="card text-center" key={dat._id}>
              <div class="card-body">
                ...
                <p id="text" class="card-text">{dat.message}</p>
                <button
                  id="button1"
                  class="card-link"
                  onClick={() =>
                    this.onClickUpdateData(dat.id, dat.message)
                  }
                >
                  EDIT NOTE
                    </button>
